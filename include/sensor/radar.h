...
#ifndef RIVER2_RADAR_H
#define RIVER2_RADAR_H
...
namespace ns_river2
{
    ...
    public:
        ...
        Eigen::Vector3d RadarVelocityFromStaticTargetArray(const Sophus::SO3d &SO3_RtoB0,
                                                           const bool &ifPrintError = false);
        Eigen::Vector3d RadarVelocityFromStaticTargetArray(const Sophus::SO3d &SO3_RtoB0,
                                                           const std::vector<size_t> &targetIndex);
        void RadarRemoveOutlier(const Sophus::SO3d &SO3_RtoB0,
        ...
        bool IfZeroVelocity(const double &outlierProb,
